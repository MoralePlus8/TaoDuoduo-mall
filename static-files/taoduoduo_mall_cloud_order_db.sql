# 创建订单服务所需数据
CREATE DATABASE /*!32312 IF NOT EXISTS */`taoduoduo_mall_cloud_order_db` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `taoduoduo_mall_cloud_order_db`;

DROP TABLE IF EXISTS `tb_taoduoduo_mall_order`;

CREATE TABLE `tb_taoduoduo_mall_order`
(
...
CREATE TABLE `tb_taoduoduo_mall_order_item`
(
