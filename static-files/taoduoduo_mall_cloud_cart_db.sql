...
CREATE DATABASE /*!32312 IF NOT EXISTS */`taoduoduo_mall_cloud_cart_db` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `taoduoduo_mall_cloud_cart_db`;

DROP TABLE IF EXISTS `tb_taoduoduo_mall_shopping_cart_item`;

CREATE TABLE `tb_taoduoduo_mall_shopping_cart_item`
(
