# 创建推荐服务所需数据
CREATE DATABASE /*!32312 IF NOT EXISTS */`taoduoduo_mall_cloud_recommend_db` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `taoduoduo_mall_cloud_recommend_db`;

# 创建首页推荐表

DROP TABLE IF EXISTS `tb_taoduoduo_mall_index_config`;

CREATE TABLE `tb_taoduoduo_mall_index_config`
(
...
INSERT INTO tb_taoduoduo_mall_index_config
(config_name, config_type, goods_id, redirect_url, config_rank, is_deleted, create_time, create_user, update_time,
 update_user)
VALUES ('热销商品 iPhone 12', 3, 10906, '##', 201, 0, '2021-03-08 18:55:49', 0, '2021-03-08 18:55:49', 0),
...
DROP TABLE IF EXISTS `tb_taoduoduo_mall_carousel`;

# 创建轮播图表

CREATE TABLE `tb_taoduoduo_mall_carousel`
(
...
INSERT INTO `tb_taoduoduo_mall_carousel` (`carousel_id`, `carousel_url`, `redirect_url`, `carousel_rank`, `is_deleted`,
                                          `create_time`, `create_user`, `update_time`, `update_user`)
VALUES (1, 'https://taoduoduo-mall.oss-cn-beijing.aliyuncs.com/images/banner2.jpg', '##', 200, 1, '2021-08-23 17:50:45',
        0, '2021-11-10 00:23:01', 0),
       (2, 'https://taoduoduo-mall.oss-cn-beijing.aliyuncs.com/images/banner1.png',
        'https://juejin.cn/book/7085254558678515742', 13, 0, '2021-11-29 00:00:00', 0, '2021-11-29 00:00:00', 0),
       (3, 'https://taoduoduo-mall.oss-cn-beijing.aliyuncs.com/images/banner3.jpg', '##', 0, 1, '2021-09-18 18:26:38',
        0, '2021-11-10 00:23:01', 0),
       (5, 'https://taoduoduo-mall.oss-cn-beijing.aliyuncs.com/images/banner2.png',
        'https://juejin.cn/book/7085254558678515742', 0, 0, '2021-11-29 00:00:00', 0, '2021-11-29 00:00:00', 0),
       (6, 'https://taoduoduo-mall.oss-cn-beijing.aliyuncs.com/images/banner1.png', '##', 101, 1, '2021-09-19 23:37:40',
        0, '2021-11-07 00:15:52', 0),
       (7, 'https://taoduoduo-mall.oss-cn-beijing.aliyuncs.com/images/banner2.png', '##', 99, 1, '2021-09-19 23:37:58',
        0, '2021-10-22 00:15:01', 0);