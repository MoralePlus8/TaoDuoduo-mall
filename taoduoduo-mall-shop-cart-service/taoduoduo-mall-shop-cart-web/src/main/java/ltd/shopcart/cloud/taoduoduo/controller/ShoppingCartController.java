...
import ltd.shopcart.cloud.taoduoduo.annotation.TokenToMallUser;
...
public class ShoppingCartController {
    ...
    public Result save(@RequestBody ShoppingCartItemDTO shoppingCartItemDTO,
                       @TokenToMallUser MallUserToken loginMallUserToken) {
        logger.info("User {} add new shoppingCartItem: {}", loginMallUserToken.getUserId(), shoppingCartItemDTO);

        shoppingCartService.save(shoppingCartItemDTO, loginMallUserToken.getUserId());
